            ...
            <ProtectedRoute>
              <aside className="w-64 bg-linear-to-br from-[#182848] via-[#22304a] to-[#2c5364] text-[#b0bec5] flex flex-col border-r border-[#22304a] shadow-2xl backdrop-blur-lg">
                <div className="px-6 py-4 flex items-center gap-2 border-b border-[#22304a]">
                  <span className="font-bold text-xl tracking-wide text-[#6ee7b7] drop-shadow">Finacle</span>
                </div>
                <nav className="flex-1 px-4 py-6 space-y-4">
                  <div className="mb-2 text-xs font-semibold text-[#6ee7b7] uppercase tracking-wider">Main Menu</div>
                  <a href="/(dashboard)" className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-[#22304a] hover:text-[#6ee7b7] font-medium transition-all">
                  ...
                  <a href="/(masters)/masters/groups" className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-[#22304a] hover:text-[#6ee7b7] transition-all">
                  ...
                  <a href="/(masters)/masters/ledger" className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-[#22304a] hover:text-[#6ee7b7] transition-all">
